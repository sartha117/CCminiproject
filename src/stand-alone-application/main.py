...
'''
def openfileEnc():
	filename = tkFileDialog.askopenfilename(initialdir = "/home/priyanka/Desktop",title = "Select file",filetypes = (("text files","*.txt"),("all files","*.*")))
	fileToEncrptyEntryUpdate(filename)

def opendirectoryEnc():
	directory = tkFileDialog.askdirectory(initialdir = "/home/priyanka/Desktop",title = "Select directory")
...
def opensarthalinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/sartha-tambe-b26106198")

def openpriyankalinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/priyanka-awatramani-b9842a192")

def opensnehalinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/sneha-lalwani-83069b1ab")
...
def main():
	...
	global form
	form = Tkinter.Tk()
	form.wm_title('Cloud Computing-Secure Text Transfer')
	'''
	-------------------------------------------------------------
	...
	text3.grid(row=5)
	priyankasocial = Label(Aboutus, text="Priyanka Awatramani")
	priyankasocial.bind("<Button-1>",openpriyankalinkedin)
	priyankasocial.grid(row=5, sticky='S',padx = 8)
	#text3 = Label(Aboutus, text="")
	#text3.grid(row=5)
	snehasocial = Label(Aboutus, text="Sneha Lalwani")
	snehasocial.bind("<Button-1>",opensnehalinkedin)
	snehasocial.grid(row=6, sticky='S',padx = 8)
	#text4 = Label(Aboutus, text="")
	#text4.grid(row=6)
	sarthasocial = Label(Aboutus, text="Sartha Tambe")
	sarthasocial.bind("<Button-1>",opensarthalinkedin)
	sarthasocial.grid(row=7, sticky='S',padx = 8)
